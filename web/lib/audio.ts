...
// call this inside a real user gesture (the "I'm ready" tap before the call) to
// "unlock" audio, so the officer's voice can autoplay afterwards. Safe to call
// multiple times; it no-ops after the first success.
